      ...
      <main className="flex-1 pt-32 pb-24">
        <div className="container mx-auto px-4 md:px-8 max-w-3xl">
            ...
            <div className="mb-12 space-y-4 border-b border-border pb-8">
                ...
                <h1 className="text-4xl font-heading font-extrabold text-foreground">{privacy.title}</h1>
            ...
            <div className="space-y-8 text-foreground leading-relaxed">
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">{privacy.section_1_title}</h2>
                    <p className="text-muted-foreground">{privacy.section_1_text}</p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">{privacy.section_2_title}</h2>
                    <p className="text-muted-foreground">{privacy.section_2_text}</p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">{privacy.section_3_title}</h2>
                    <p className="text-muted-foreground">{privacy.section_3_text}</p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">{privacy.section_4_title}</h2>
                    <p className="text-muted-foreground">{privacy.section_4_text}</p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">{privacy.section_5_title}</h2>
                    <p className="text-muted-foreground">{privacy.section_5_text}</p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">{privacy.section_6_title}</h2>
