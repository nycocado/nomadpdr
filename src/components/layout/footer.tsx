    ...
    <footer className="bg-muted text-foreground pt-16 pb-8 border-t border-border">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <h4 className="font-bold mb-4 text-secondary">
              {dict.links_title}
            </h4>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary font-bold border border-foreground/20 px-2 py-1 rounded transition-colors hover:border-primary"
            >
